...
class Tests:
    ...
    def test_get_question_type(self, monkeypatch):
        ...
        status = { 'using_random': False, 'got_sum': False, 'got_difference': False, 'got_other': False }
    ...
    def test_print_congratulations(self, capsys):
        ...
        captured = capsys.readouterr() # capture print output
        assert captured.out.strip() == "Yes! Congratulations on the successful addition!"

        app_functions.print_congratulations("difference")
        captured = capsys.readouterr() # capture print output
        assert captured.out.strip() == "Yes! Congratulations on the successful subtraction!"
