...
class Tests:
    ...
    def test_main(self, capsys, monkeypatch):
        ...
        monkeypatch.setattr("app_functions.print_question", lambda x, y, z: print("You rolled a 3 and a 5... What is the sum of 3 and 5?"))
        ...
        monkeypatch.setattr("app_functions.print_congratulations", lambda: print("Yes! Congratulations on the successful addition!"))
        monkeypatch.setattr("app_functions.print_correct_answer", lambda x, y, z: print("No! The sum of 3 and 5 is 8!"))
        monkeypatch.setattr("app_functions.print_error_message", lambda: print("Sorry - that is an invalid answer.  Bye Bye!"))
